...
import sys
print("MONGO_URL present:", 'MONGO_URL' in os.environ, flush=True)
print("All env keys:", list(os.environ.keys()), flush=True)
sys.stdout.flush()
...
db = client[os.environ.get('DB_NAME', 'le_marche')]
